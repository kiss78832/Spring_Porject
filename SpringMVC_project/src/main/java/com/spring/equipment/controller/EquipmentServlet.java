...
//				byte[] eq_pic = req.getParameter("eq_pic").getBytes();
				...
				/*************************** 2.開始修改資料 *****************************************/
				EquipmentService equSvc = new EquipmentService();
				equVO = equSvc.updateEquipment(eq_num, eq_name, eq_type, eq_size, eq_brand, eq_price, eq_status, eq_pic,
						eq_detail, type_eq_num);
...
//				byte[] eq_pic = req.getParameter("eq_pic").getBytes();
				...
				/*************************** 2.開始新增資料 ***************************************/
				EquipmentService equSvc = new EquipmentService();
				equVO = equSvc.addEquipment(eq_name, eq_type, eq_size, eq_brand, eq_price, eq_status, eq_pic, eq_detail,
						type_eq_num);
