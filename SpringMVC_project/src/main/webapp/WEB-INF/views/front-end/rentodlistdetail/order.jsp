...
<%@ page import="com.spring.member.model.*"%><%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%@ page import="java.util.*"%>
<%@ page import="com.spring.rentoddetail.model.*"%>
<%@ page import="com.spring.member.model.*"%>
<%@ page import="com.spring.rentodlist.model.RentOdListService"%>
<%@ page import="com.spring.rentodlist.model.RentOdListVO"%>
<%	
...
<jsp:useBean id="memberSvc" scope="page" class="com.spring.member.model.MemberService" />
<jsp:useBean id="equipmentSvc" scope="page" class="com.spring.equipment.model.EquipmentService" />
