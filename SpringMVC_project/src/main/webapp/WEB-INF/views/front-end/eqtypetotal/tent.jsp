...
<%
	...
	List<EquipmentVO> list = equSvc.getOneType("帳篷");
...
<body>
	<div class="container-fluid">
		<div class="row">
			...
			/WEB-INF/views/common/navbar.jsp" flush="true" />
  ...
  <div class="vcontainter">
      ...
      <div>Find where you truly belong</div>
					...
					<div class="path">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="">帳篷</a></li>
									...
									<div class="product-grid2">
										<div class="product-image2">
											<a href="#"> <img class="pic-1"
												...
												href="<%=request.getContextPath()%>/equipment/equipment.do?eq_num=${equVO.eq_num}&requestURL=<%=request.getServletPath()%>&action=getOne_From06">Add
												to cart</a>
										</div>
										<div class="product-content">
											<h3 class="title">
												<a href="#">商品名稱:${equVO.eq_brand} ${equVO.eq_name}</a>
											</h3>
	...
	<c:if test="${openModal!=null}">
		...
		/WEB-INF/views/WEB-INF/views/front-end/equipment/listOneEqu.jsp"  flush="true"/>
