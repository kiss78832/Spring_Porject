...
<%
	...
	List<EquipmentVO> list = equSvc.getOneType("拐杖");
...
<%
	...
	memberVO = dao.findByPrimaryKey("A001");
      ...
      <div>Find where you truly belong</div>
					...
					<div class="path">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="">登山杖</a></li>
...
<!-- 						<div class="card card-cascade wider col-lg-3 " -->
<%-- 							onclick="location.href='<%=request.getContextPath()%>/equipment/equipment.do?eq_num=${equVO.eq_num}&action=getOne_From06';"> --%>
...
<!-- 								Title -->
<!-- 								<h4 class="card-title"> -->
<%-- 									<strong>${equVO.eq_name}</strong> --%>
<!-- 								</h4> -->
<!-- 								Subtitle -->
<!-- 								<h5 class="blue-text pb-2"> -->
<%-- 									<strong>價錢 : ${equVO.eq_price}</strong> --%>
<!-- 								</h5> -->
<!-- 								Text -->
<%-- 								<p class="card-text">${equVO.eq_brand}</p> --%>
...
<!-- 								Card footer -->
<!-- 								<div class="card-footer text-muted text-center mt-4">2 -->
<!-- 									days ago</div> -->
...
<c:if test="${openModal!=null}">
		...
		<jsp:include page="/WEB-INF/views/front-end/equipment/listOneEqu.jsp" />
