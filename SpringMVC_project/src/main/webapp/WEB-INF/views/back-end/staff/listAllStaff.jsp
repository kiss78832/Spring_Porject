...
<jsp:useBean id="sSvc" scope="page" class="com.spring.staff.model.StaffService"/>
<jsp:useBean id="authoritySvc" scope="page" class="com.spring.authority.model.AuthorityService"/>
<jsp:useBean id="authoritySvc2" scope="page" class="com.spring.authority.model.AuthorityService"/>
<jsp:useBean id="functionSvc" scope="page" class="com.spring.function.model.FunctionService"/>
<!DOCTYPE html>
<html>
<head>
