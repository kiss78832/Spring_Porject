...
<%@ page import="com.dailyBed.model.*"%>
<!DOCTYPE html>
...
<jsp:useBean id="locSvc" class="com.location.model.LocationService" />
<jsp:useBean id="mealSvc" class="com.meal.model.MealService" />
<jsp:useBean id="dailyBedSvc" class="com.dailyBed.model.DailyBedService" />
