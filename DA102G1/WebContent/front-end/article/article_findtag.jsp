...
<%
	...
	String element = request.getAttribute("element").toString();
	
	List<ArticleVO> list = articleSvc.getArticle_tag(element);
	pageContext.setAttribute("list", list);
	
%>
<%-- ${atiSvc.getall(1).article_id} --%>
<%-- ${articleSvc.getall(one_articleid)} --%>
		...
		<div class="row">
			...
			<div class="col-lg-12 contentbox">
				...
				<div id="centerbox" class="container-fluid m-auto">
					...
					<div>
						<a href="<%=application.getContextPath()%>/front-end/article/article_front.jsp"><input type="image" class="img_icon" src="<%=request.getContextPath()%>/assets/images/Icon/home1.png"></a>
					</div>	
					</div>
...
<%-- 						<c:if test="${atiSvc.getOneAti(articleVO.article_id).report_status == 0}"> --%>
							<div class="col-lg-4">
