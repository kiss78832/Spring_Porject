...
<title>Island Peak Article Edit</title>
<link rel="stylesheet"
...
<FORM action="<%=application.getContextPath() %>/article/article.do" method="post" enctype="multipart/form-data" >
				<div id="centerbox" class="container-fluid m-auto">
					...
					<div class="row">
					    <input type="text"  name="article_title" class="title" placeholder="請輸入文章標題"/>
						...
						<div class="row">
							<div id="article">
								...
								<textarea class="ckeditor" name="article_content"></textarea>
					...
					<div class="row">
						<div class="col-6" style="margin: auto; float:left;" onkeydown="init1()">    
						...
						<button id="sub_reset">取消編輯</button>
						<button type="submit" id="sub_btn">確認送出</button>
	...
	<!-- JS -->
<script
	src="<%=request.getContextPath()%>/assets/javascripts/ChangeInput.js"type="text/javascript">
</script>
...
// $('.btnn').mousedown(function(e) {
// 		var data = {action: "style_css", add: 'false'};
// 			$.ajax({
// 				 type:'POST',
