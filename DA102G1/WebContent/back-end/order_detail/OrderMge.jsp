...
<%
	...
	List<Room_orderVO> room_orderList = room_orderSvc.getAll();
...
<link rel="stylesheet" type="text/css"
	href="<%=application.getContextPath()%>/assets/stylesheets/backgroundContext.css">
								...
								<div class="topBox">
									...
									<ul class="list-inline two-part">
										...
										<li class="text-center"><i
											...
											data-count="<%=room_orderSvc.getAllByNotPaid()%>"
											id="notPaid">0</span></li>
									</ul>
								</div>
							</div>
							<div class="col-lg-4 col-xs-12">
								<div class="topBox">
									...
									<ul class="list-inline two-part">
										...
										<li class="text-center"><i
											...
											data-count="<%=room_orderSvc.getAllByAlreadyPaid()%>"
											id="paid">0</span></li>
									</ul>
								</div>
							</div>
								...
								<div class="topBox">
									...
									<ul class="list-inline two-part">
										...
										<li class="text-center"><i class="ti-arrow-up text-info"></i>
											...
											data-count="<%=room_orderSvc.getCountToday()%>"
											id="todayOrder">0</span></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 col-lg-12 col-sm-12">
									...
									<div class="filterList row">
										...
										<FORM METHOD="post"
											...
											<select class="form-control1" name="member_id"
												id="member_idSelect">
										...
										<FORM METHOD="post"
											...
											<select class="form-control1" name="date_range"
												id="dateRange_idSelect">
										...
										<FORM METHOD="post"
											...
											<select class="form-control1" name="group_id"
												id="group_idSelect">
										...
										<FORM METHOD="post"
											...
											<input type="hidden" name="action"
												value="getAllByOrderStatus"> <select
												class="form-control1" name="order_status" id="order_status">
										...
										<FORM METHOD="post"
											...
											<input type="hidden" name="action"
												value="getAllByPaymentStatus"> <select
												class="form-control1" name="payment_status"
												id="payment_status">
								...
								<form METHOD="post"
									...
									<input type="hidden" name="action" value="locSelectForChart">
									<select size="1" name="location_id" class="form-control1"
										...
										<FORM METHOD="post"
											...
											<input type="hidden" name="action" value="getAll"> <input
												type="submit" value="查詢全部" class="form-control1">
										</FORM>
									</div>
									<div class="">
											...
											<tbody>
												...
												<c:forEach var="room_orderVO" items="${room_orderList}"
													...
													<tr>
														...
														<td><c:choose>
																<c:when
																	test="${room_orderVO.order_status != 4 && room_orderVO.order_status != 5}">
																	<img
