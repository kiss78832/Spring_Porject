...
<jsp:useBean id="staffVO" scope="request" class="com.staff.model.StaffVO"/>
...
.UpdateStaffTitle input[type=text],input[type=password]{
	width: 300px;
	height:45px;
}
.UpdateStaffTitle input[type=radio]+span{
	font-size:24px;
}
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			...
			<br><br>
	     	...
	     	<form class="UpdateStaffTitle" action="<%= application.getContextPath()%>/staff/staff.do" method="POST">
	     		...
	     		<table>
	     			...
	     			<tr>
	     				...
	     				<td>
							<div class="form-group">
								<span>${staffVO.sf_id }</span>
								<input type="hidden" class="form-control" name="sf_id" placeholder="請填帳號" value="${staffVO.sf_id }">
							</div>
	     				</td>
	     			...
	     			<tr>
	     				...
	     				<td>
							<div class="form-group">
								<input type="text" class="form-control" name="sf_account" placeholder="請填帳號" value="${staffVO.sf_account }">
							</div>
	     				</td>
	     			...
	     			<tr>
	     				...
	     				<td>
	     					<label>
	     						<input class="gender" type="radio" name="gender" value="1" checked> <span>男</span>
	     					</label><br>
	     					<label>
	     						<input class="gender" type="radio" name="gender" value="2"> <span>女</span>
	     					</label>
	     			...
	     			<tr>
	     				...
	     				<td>
							<div class="form-check">
								<label>
								  <input class="form-check-input" type="radio" name="sf_status" id="sf_status1" value="1" checked>
								    <span>在職</span>
								</label>
							</div>
							<div class="form-check">
								<label>
								  <input class="form-check-input" type="radio" name="sf_status" id="sf_status2" value="2">
								    <span>離職</span>
							    </label>
							</div>
