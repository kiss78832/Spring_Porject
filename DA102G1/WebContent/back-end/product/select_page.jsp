...
<ul>
  ...
  <jsp:useBean id="equSvc" scope="page" class="com.equipment.model.EquipmentService" />
...
<%--      <jsp:useBean id="equttSvc" scope="page" class="com.equtypetotal.model.EquTotalService" /> --%>
